...
public class StreamMinMaxEx {
	...
	public static void main(String[] args) {
		...
		Integer min = Stream.of(2, 5, 2, 9, 1).min(Comparator.comparing(Integer::valueOf)).get();
		System.out.println(" min =  " + min);

		Integer max = Stream.of(2, 5, 9, 1, 3).max(Comparator.comparing(Integer::valueOf)).get();
