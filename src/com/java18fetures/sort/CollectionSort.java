...
public class CollectionSort {
	...
	public static void main(String[] args) {
		...
		list.stream().filter(x -> x < 14).map(x -> x * 2).forEach(System.out::println);
		...
		List<Integer> descsortedList = list.stream().sorted((i1, i2) -> i2.compareTo(i1)).collect(Collectors.toList());
